# QALD9 plus wikidata MST5 reverse 110 ##################################################################################

TENTRIS_DIR="/upb/users/q/quannian/profiles/unix/cs/Tentris/QALD9-plus-wikidata"
...
./tentris_new serve 0.0.0.0:9070 > tentris_check_output.log 2>&1 &
pid=$!
...
if grep -q 'os error 131' tentris_check_output.log; then
    ...
    ./tentris_new serve 0.0.0.0:9070 > "tentris_check_output_$(date +%Y%m%d%H%M%S).log" 2>&1 &
    pid=$!
    echo "$pid" > tentris.pid
    disown "$pid"
fi
...
# QALD9 plus wikidata MST5 reverse 111 ##################################################################################
...
java -cp target/prune-cel-0.0.1-SNAPSHOT.jar org.dice_research.cel.PruneCEL_CLI \
    ...
    --skipNone true \
    --inputFile ./././././T_F_Json/QALD9_plus_wikidata/TandF_MST5_reverse.json \
    --outputFile ./././././Results/QALD9plus-wikidata/MST5_reverse/MST5_reverse_111.csv \
    --cluster false \
    --folds 1 \
    --foldTrainTestSavePath Fold/QALD10_MST5
...
# QALD9 plus wikidata MST5 reverse 112 ##################################################################################
...
java -cp target/prune-cel-0.0.1-SNAPSHOT.jar org.dice_research.cel.PruneCEL_CLI \
    ...
    --skipNone true \
    --inputFile ./././././T_F_Json/QALD9_plus_wikidata/TandF_MST5_reverse.json \
    --outputFile ./././././Results/QALD9plus-wikidata/MST5_reverse/MST5_reverse_112.csv \
    --cluster false \
    --folds 1 \
    --foldTrainTestSavePath Fold/QALD10_MST5
...
# QALD9 plus wikidata deeppavlov reverse 110 ##################################################################################
...
java -cp target/prune-cel-0.0.1-SNAPSHOT.jar org.dice_research.cel.PruneCEL_CLI \
    ...
    --recursive true \
    --skipNone true \
    --inputFile ./././././T_F_Json/QALD9_plus_wikidata/TandF_deeppavlov_reverse.json \
    --outputFile ./././././Results/QALD9plus-wikidata/Deeppavlov_reverse/Deeppavlov_reverse_110.csv \
    --cluster false \
    --folds 1 \
    --foldTrainTestSavePath Fold/QALD10_MST5
...
# QALD9 plus wikidata deeppavlov reverse 111 ##################################################################################
...
java -cp target/prune-cel-0.0.1-SNAPSHOT.jar org.dice_research.cel.PruneCEL_CLI \
    ...
    --skipNone true \
    --inputFile ./././././T_F_Json/QALD9_plus_wikidata/TandF_deeppavlov_reverse.json \
    --outputFile ./././././Results/QALD9plus-wikidata/Deeppavlov_reverse/Deeppavlov_reverse_111.csv \
    --cluster false \
    --folds 1 \
    --foldTrainTestSavePath Fold/QALD10_MST5
...
# QALD9 plus wikidata deeppavlov reverse 112 ##################################################################################
...
java -cp target/prune-cel-0.0.1-SNAPSHOT.jar org.dice_research.cel.PruneCEL_CLI \
    ...
    --skipNone true \
    --inputFile ./././././T_F_Json/QALD9_plus_wikidata/TandF_deeppavlov_reverse.json \
    --outputFile ./././././Results/QALD9plus-wikidata/Deeppavlov_reverse/Deeppavlov_reverse_112.csv \
    --cluster false \
    --folds 1 \
    --foldTrainTestSavePath Fold/QALD10_MST5
