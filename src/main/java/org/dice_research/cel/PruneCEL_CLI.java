...
//    {
//        // http://dice-quan.cs.uni-paderborn.de:90X0/sparql
//        // "http://dice-quan.cs.uni-paderborn.de:9010/sparql"   Family
//        // "http://dice-quan.cs.uni-paderborn.de:9020/sparql"   Carcinogenesis
//        // "http://dice-quan.cs.uni-paderborn.de:9030/sparql"   Mutagenesis
//        // "http://dice-quan.cs.uni-paderborn.de:9080/sparql"   QALD10
...
//                    "./././././Fold/Carcinogenesis/Result/Carcinogenesis" + result + ".csv", false, 10, "Fold/Carcinogenesis");
//            }
//            catch (IOException e) {
//                System.err.println("Carcinogenesis" + e.getMessage());
//                e.printStackTrace();
//            }
//
            // ++++++++++Mutagenesis++++++++++ //
...
//                "./././././Fold/Mutagenesis/Result/Mutagenesis" + result + ".csv", false,10,"Fold/Mutagenesis");
//            }
//            catch (IOException e) {
//                System.err.println("Mutagenesis" + e.getMessage());
//                e.printStackTrace();
//            }
//
            //++++++++++Family++++++++++ //
...
//                "./././././Fold/Family/Result/Family" + result + ".csv", false,10,"Fold/Family");
//            }
//            catch (IOException e) {
//                System.err.println("Family" + e.getMessage());
//                e.printStackTrace();
//            }
//
//
...
//                "./././././Fold/QALD10/Result/QALD10_MST5" + "112" + ".csv", false,10,"Fold/QALD10_MST5");
//            }
//            catch (IOException e) {
...
//                "./././././Fold/QALD10/Result/QALD10_Deeppavlov" + "112" + ".csv", false,10,"Fold/QALD10_Deeppavlov");
//            }
//            catch (IOException e) {
...
//                "./././././Fold/QALD10/Result/QALD10_Deeppavlov_Reverse" + "112" + ".csv", false,10,"Fold/QALD10_Deeppavlov_Reverse");
//            }
//            catch (IOException e) {
...
//                Recursive, SetSkipNone, "./././././T_F_Json/QALD9_plus_dbpedia/TandF_MST5.json",
//                "./././././Fold/QALD9_plus_dbpedia/Result/QALD9_plus_dbpedia_MST5" + result + ".csv", false,10,"Fold/QALD9_plus_dbpedia_MST5");
//            }
//            catch (IOException e) {
//                System.err.println("QALD9P_DBPEDIA MST5" + e.getMessage());
//                e.printStackTrace();
//            }
//
            // Ganswer //
...
//                "./././././Fold/QALD9_plus_dbpedia/Result/QALD9_plus_dbpedia_ganswer" + result + ".csv", false,10,"Fold/QALD9_plus_dbpedia_ganswer");
//            }
//            catch (IOException e) {
...
//                "./././././Fold/QALD9_plus_dbpedia/Result/QALD9_plus_dbpedia_tebaqa" + result + ".csv", false,10,"Fold/QALD9_plus_dbpedia_tebaqa");
//            }
//            catch (IOException e) {
...
//            try {
//            runPruneCEL("http://dice-quan.cs.uni-paderborn.de:9050/sparql", "ALC", accuracyfunction, true, true, 0, 600000,
//                Recursive, SetSkipNone, "./././././T_F_Json/QALD9_plus_dbpedia/TandF_MST5_reverse.json",
//                "./././././Fold/QALD9_plus_dbpedia/Result/QALD9_plus_dbpedia_MST5_Reverse" + result + ".csv", false,10,"Fold/QALD9_plus_dbpedia_MST5_Reverse");
//            }
//            catch (IOException e) {
...
//                "./././././Fold/QALD9_plus_dbpedia/Result/QALD9_plus_dbpedia_ganswer_Reverse" + result + ".csv", false,10,"Fold/QALD9_plus_dbpedia_ganswer_Reverse");
//            }
//            catch (IOException e) {
//                System.err.println("QALD9P_DBPEDIA Ganswer Reverse" + e.getMessage());
//                e.printStackTrace();
//            }
//            // Tebaqa_Reverse //
//            try {
//            runPruneCEL("http://dice-quan.cs.uni-paderborn.de:9050/sparql", "ALC", accuracyfunction, true, true, 0, 600000,
//                Recursive, SetSkipNone, "./././././T_F_Json/QALD9_plus_dbpedia/TandF_tebaqa_reverse.json",
//                "./././././Fold/QALD9_plus_dbpedia/Result/QALD9_plus_dbpedia_tebaqa_Reverse" + result + ".csv", false,10,"Fold/QALD9_plus_dbpedia_tebaqa_Reverse");
//            }
//            catch (IOException e) {
