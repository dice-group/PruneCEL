...
/**
 * An extension of the {@link SuggestorWithInstances} interface that is able to score a given
 * expression.
 * 
 * @author Michael R&ouml;der (michael.roeder@uni-paderborn.de)
 *
 */
public interface ExtendedSuggestorWithInstances extends SuggestorWithInstances {
     ...
     */
    SelectionScoresWithInstances scoreExpressionWithInstances(ClassExpression expression, Collection<String> positive,
            Collection<String> negative, Map<String, Integer> positiveMaps,
