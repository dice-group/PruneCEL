...
public class SparqlBasedSuggestorQueryGenerationTest implements Comparator<ScoredIRI> {
    ...
    public SparqlBasedSuggestorQueryGenerationTest(ClassExpression input, String logic, Model model, String[] positives,
